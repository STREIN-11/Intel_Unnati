...
$b = array(trim(file_get_contents('cap_p2.txt')));
$c = array(trim(file_get_contents('cap_w1.txt')));
$dataPoints = array();
array_push($dataPoints,array("label"=> "Capacity 1", "y"=> $a));
array_push($dataPoints,array("label"=> "Capacity 1", "y"=> $b));
array_push($dataPoints,array("label"=> "Capacity 1", "y"=> $c));
?>
<!DOCTYPE HTML>
<html>
<head>
...
if (in_array("0", $y)) {
  echo "<p class='mycss'><h2>Motor 1 is On</h2></p>";
  echo "<p class='mycss'><h2>Motor 2 is Off</h2></p>";
  echo "<p class='mycss'><h2>Motor 3 is Off</h2></p>";
}
elseif (in_array("1", $y)) {
  echo"<p class='mycss'><h2>Motor 1 is Off</h2></p>";
  echo"<p class='mycss'><h2>Motor 2 is On</h2></p>";
  echo"<p class='mycss'><h2>Motor 3 is Off</h2></p>";
} 
elseif (in_array("2", $y)){
  echo"<p class='mycss'><h2>Motor 1 is Off</h2></p>";
  echo"<p class='mycss'><h2>Motor 2 is Off</h2></p>";
  echo"<p class='mycss'><h2>Motor 3 is On</h2></p>";
}
else {
  echo"<p class='mycss'><h2>Motor 1 is Off</h2></p>";
  echo"<p class='mycss'><h2>Motor 2 is Off</h2></p>";
